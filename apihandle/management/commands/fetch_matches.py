...
RAPIDAPI_KEY = "7e9555999cmsh27c7d1203fc284bp113fe6jsn6971223d989e"
        ...
        try:
            with transaction.atomic():
                ...
                if 'response' not in data:
                    self.stderr.write(self.style.ERROR(f"Key 'response' not found in API response"))
                    return
                ...
                for fixture_data in data['response']:
                    ...
                    league, created = League.objects.get_or_create(
                        ...
                        country=league_info.get('country', ''),  # Provide default value or handle missing key
                    ...
                    Match.objects.update_or_create(
                        ...
                        home_team_score=score_info['fulltime']['home'] if score_info['fulltime']['home'] else 0,
                        away_team_score=score_info['fulltime']['away'] if score_info['fulltime']['away'] else 0,
                        # venue_name=fixture_info['venue']['name'],
                        # venue_city=fixture_info['venue']['city'] if 'city' in fixture_info['venue'] else 'Unknown City',
                    )

                self.stdout.write(self.style.SUCCESS('Successfully fetched and saved match data'))
